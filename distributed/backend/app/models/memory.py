...
class Memory(Base):
    ...
    consolidation_score: Mapped[float] = mapped_column(Float, default=0.5, index=True)  # 0.0 -> pruned, 1.0 -> permanent
    feedback_score: Mapped[float] = mapped_column(Float, default=0.5)       # 0.0 -> negative, 1.0 -> positive
